...
- [x] **Phase 3: Column, Sort & Selection Controls** - Kolumn visa/dölj, sortering (klick på rubrik), global fri-text-sök och förbättrade multi-val.
...
Plans:
- [x] 03-01-PLAN.md — Backend: global search + sort semantics
- [x] 03-02-PLAN.md — Frontend: global search + column visibility per mode + sort UX rules
...
| 3. Column, Sort & Selection Controls | 2/2 | Complete | 2026-04-15 |
