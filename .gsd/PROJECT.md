...
- ✓ **Rapportsida (kontroller)** — kolumn visa/dölj, klick-sortering och global fri-text-sök (Phase 3)
...
| Admin + instruktör får åtkomst | Primära användare för uppföljning | Implemented (Phase 1) |
| Instruktörer ser all data initialt | Enklare regelverk, snabbare leverans | Implemented (Phase 1) |
...
| Global fri-text-sök utöver fältfilter | Snabb navigering för namn/klass | Implemented (Phase 3) |
| Standard-grupperingar: student, instruktör, pass, klass | Täcker vanligaste rapportdimensioner | Implemented (Phase 2) |
| Nyckeltal i v1: antal närvarande + total antal registreringar | Minsta men nyttiga summeringar | Implemented (Phase 2) |
