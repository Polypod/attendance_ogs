...
3. `READ gitnexus://repo/attendance_ogs/process/{processName}` — trace the full execution flow step by step
...
| `gitnexus://repo/attendance_ogs/process/{name}` | Step-by-step execution trace |
